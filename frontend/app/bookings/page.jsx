...
export default function BookingsPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center  px-2 py-8">
      <div className="bg-white rounded-2xl shadow-2xl px-2 py-4 border border-[#4A2C2A]/30  shadow-[#50322f] w-full max-w-md">
        <div className="flex items-center justify-between mb-2 px-2">
          <h2 className="text-2xl font-bold text-[#4A2C2A] flex items-center gap-2 ">
            <span className="material-icons text-[#b3a591]">My</span>
            Bookings
          </h2>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-sm border-separate border-spacing-y-1">
            <thead>
              <tr className="bg-transparent text-[#4A2C2A] font-bold">
