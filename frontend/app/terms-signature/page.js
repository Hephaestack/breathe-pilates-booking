...
Το Breathe Pilates – Efi Zikou είναι ένας χώρος ομαδικής και ατομικής άσκησης, που προσφέρει:

• Pilates Mat
• Pilates Equipment (Reformer, Wunda Chair, Cadillac, Ladder Barrel)
• Κυκλική αερόβια προπόνηση
• Yoga
• Προγράμματα Pilates για ειδικές πληθυσμιακές ομάδες (μυοσκελετικά προβλήματα, οστεοπόρωση, εγκυμοσύνη, λοχεία, αυτοάνοσα, εφηβεία, γήρανση)


ΙΑΤΡΙΚΗ ΒΕΒΑΙΩΣΗ

• Για να γίνεται μέλη στο Breathe Pilates Studio είναι απαραίτητο να μας προσκομίσετε μία βεβαίωση γιατρού
• Η βεβαίωση μπορεί να προέρχεται από γενικό γιατρό, παθολόγο ή καρδιολόγο
• Σε περίπτωση συγκεκριμένου προβλήματος υγείας ή κατάστασης που χρήζει ιδιαίτερης προσοχής, την βεβαίωση σας την δίνει ο γιατρός που σας παρακολουθεί


ΣΥΝΔΡΟΜΕΣ

• Οι συνδρομές είναι μηνιαίες και προκαταβάλονται
• Η συνδρομή σας έχει ισχύ από την ημέρα που ξεκινήσατε και διάρκεια 30 ημέρες
• Μαθήματα που χάνονται στο πλαίσιο συνδρομής δεν μπορούν να αναπληρωθούν σε προηγούμενες ή επόμενες εβδομάδες.
• Τα πακέτα έχουν ισχύ από την ημέρα που ξεκινήσατε και διάρκεια 90 ημέρες
• Τα πακέτα μαθημάτων είναι ιδανικά για όσους δεν έχουν σταθερό πρόγραμμα, καθώς σας δίνουν την ελευθερία να παρακολουθείτε όσα μαθήματα θέλετε την εβδομάδα.
• Οι συνδρομές και τα πακέτα είναι ονομαστικά και δεν μεταβιβάζονται, ούτε επιστρέφονται
...
• Η κράτηση θέσης γίνεται το αργότερο 1μιση ώρα πριν το μάθημα
• Ακυρώσεις γίνονται το αργότερο 2 ώρες πριν το μάθημα
...
• Να έχετε νεράκι και πετσέτα
• Οι τσάντες και προσωπικά αντικείμενα φυλάσσονται στα lockers
...
Cadillac Flow / Clinical Pilates πακέτα:
• 1 μάθημα → 15€
• 5 μαθήματα → 70€
• 10 μαθήματα → 130€
