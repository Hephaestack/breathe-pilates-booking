      ...
      <div className={`bg-white rounded-2xl shadow-2xl px-4 py-6 border-4 ${borderColor} w-full max-w-md shadow-[#50322f]`}>
        ...
        <div className="bg-gradient-to-r from-[#a09e7e] via-[#A5957E] to-[#50322f] rounded-xl p-4 mb-4">
          ...
          <div className="flex items-center justify-between mt-2">
            ...
            <button
              className="ml-4 px-4 py-2 bg-[#BFA2DB] text-white font-semibold rounded-xl shadow hover:bg-[#a58e8c] transition"
              disabled={isFull}
              onClick={() => alert(isFull ? 'Class is full!' : 'Booking confirmed!')}
            >
              Book a Program
            </button>
          </div>
